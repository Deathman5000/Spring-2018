//C432109 JOB 1,'JAMES HUND',NOTIFY=&SYSUID
//********************************************************************
//*    JCL TO SORT C432109.DATA(DATA1) BY THE FIRST                  *
//*    THREE CHARACTER FIELDS AND WRITE OUTPUT                       *
//*    TO C432109.DATA(OUT1), NEED TO CHANGE **                      *
//********************************************************************
...
//STEP1 EXEC PGM=SORT
//SORTIN DD DISP=SHR,DSN=C432109.DATA(BULB)
//SORTOUT DD DISP=SHR,DSN=C432109.DATA(BOUT1)
//SYSOUT DD SYSOUT=*
//SYSIN DD *
...
//STEP2 EXEC PGM=SORT
//SORTIN DD DISP=SHR,DSN=C432109.DATA(BULB)
//SORTOUT DD DISP=SHR,DSN=C432109.DATA(BOUT2)
//SYSOUT DD SYSOUT=*
//SYSIN DD *
...
//STEP3 EXEC PGM=SORT
//SORTIN DD DISP=SHR,DSN=C432109.DATA(BULB)
//SORTOUT DD DISP=SHR,DSN=C432109.DATA(BOUT3)
//SYSOUT DD SYSOUT=*
