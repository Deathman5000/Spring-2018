...
//**************//
//** ASSEMBLE **//
//** THIS JCL REQUIRES AN INPUT DATASET C4321XX.TEXT(NIN)
//**************//
//ASSEMBLE EXEC PGM=ASMA90
//SYSIN    DD DSN=C432109.ASM(HW6),DISP=SHR
...
//SYSUT1   DD DSN=&&SYSUT1,DISP=(,PASS)
//SYSLMOD  DD DSN=C432109.LOAD(HW6),DISP=(OLD,CATLG)
//SYSPRINT DD SYSOUT=*
//*********//
//** GO ***//
//*********//
//RUN      EXEC PGM=HW6
//SYSIN    DD DSN=C432109.TEXT(NIN),DISP=SHR
