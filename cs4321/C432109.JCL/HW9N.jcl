...
//**************//
//** ASSEMBLE **//
//** THIS JCL REQUIRES AN INPUT DATASET C4321XX.TEXT(HW9NIN)
//**************//
//ASSEMBLE EXEC PGM=ASMA90
//SYSIN    DD DSN=C432109.ASM(HW9N),DISP=SHR
...
//SYSUT1   DD DSN=&&SYSUT1,DISP=(,PASS)
//SYSLMOD  DD DSN=C432109.LOAD(HW9N),DISP=(OLD,CATLG)
//SYSPRINT DD SYSOUT=*
//*********//
//** GO ***//
//*********//
//RUN      EXEC PGM=HW9N
//SYSIN    DD DSN=C432109.TEXT(HW9NIN),DISP=SHR
