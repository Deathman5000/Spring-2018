...
//**************//
//** ASSEMBLE **//
//** THIS JCL REQUIRES AN INPUT DATASET C4321XX.TEXT(PIN)
//**************//
//ASSEMBLE EXEC PGM=ASMA90
//SYSIN    DD DSN=C432109.ASM(HW8),DISP=SHR
...
//SYSUT1   DD DSN=&&SYSUT1,DISP=(,PASS)
//SYSLMOD  DD DSN=C432109.LOAD(HW8),DISP=(OLD,CATLG)
//SYSPRINT DD SYSOUT=*
//*********//
//** GO ***//
//*********//
//RUN      EXEC PGM=HW8
//SYSIN    DD DSN=C432109.TEXT(PIN),DISP=SHR
